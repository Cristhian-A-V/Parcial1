...
using ParcialCristhianArispe.Models;
using ParcialCristhianArispe.Providers;
using ParcialCristhianArispe.Results;

namespace ParcialCristhianArispe.Controllers
{
    [Authorize]
